...
$style = "";
$html = "";
$html = '<h2 style="text-align:center"><font color="#000000">Listado de Usuarios Registrados</font></h2>';
...
foreach ($listado as $v) {
    ...
    $html .= '<tr ' . $style . '><td style="text-align: center;">' . $v['idusuario'] . '</td>';
    $html .= '<td style="text-align: center;">' . $v['nombre'] . '</td>';
    $html .= '<td style="text-align: center;">' . $v['email'] . '</td>';
    $html .= '<td style="text-align: center;">' . $v['fecha_registro'] . '</td>';
    $html .= '<td style="text-align: center;">' .  $v['nombreperfil'] . '</td></tr>';    
