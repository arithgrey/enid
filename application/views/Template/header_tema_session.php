...
<!-- Mirrored from htmlcoder.me/preview/the_project/v.1.0/template/index-portfolio.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jun 2015 15:27:03 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <div class="col-xs-2 col-sm-5">
                ...
                <div class="header-top-first clearfix">
                  <ul class="social-links circle small clearfix hidden-xs">
                    <li class="twitter"><a target="_blank" href="http://www.twitter.com/enidservice"><i class="fa fa-twitter"></i></a></li>                                        
                  ...
                  <div class="social-links hidden-lg hidden-md hidden-sm circle small">
                    <div class="btn-group dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-animation">
                        <li class="twitter"><a target="_blank" href="http://www.twitter.com/enidservice"><i class="fa fa-twitter"></i></a></li>                                                                                                                    
                        <li class="facebook"><a target="_blank" href="https://www.facebook.com/pages/Enid-service/645179855527609?ref=hl"><i class="fa fa-facebook"></i></a></li>                        
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-3">
                ...
                <div class="header-left clearfix">
                  ...
                  <div id="logo" class="logo">
                    <a href="<?=base_url()?>"><img id="logo_img" src="<?=base_url('application/img/Enid2.png')?>" alt="The Project"></a>
                  </div>
